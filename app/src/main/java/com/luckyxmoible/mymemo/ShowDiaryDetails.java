...
public class ShowDiaryDetails extends AppCompatActivity implements AddLockDialog.MyDialogInterface{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mImageListFragment2 = (ImageListFragment)fm3.findFragmentById(R.id.image_show);
        ...
        if(diary.isLocked){
            ...
            mImageListFragment2.mImageStorages.uris = new Vector<>(0);
            showNoticeDialog();
        }else{
        ...
        bt_back.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                mImageListFragment2.setUris(new ImageStorage());
    ...
    public void presentNoLock(TextView content,TextView place){
        ...
        assert mImageListFragment2 != null;
        mImageListFragment2.setUris(new ImageStorage(diary.uris));
    }
